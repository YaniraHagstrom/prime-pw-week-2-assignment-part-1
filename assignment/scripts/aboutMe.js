...
let firstName = 'Yanira';

// 2 - Create a second variable called `lastName` and assign it the value of your last name

let lastName = 'Hagstrom';
...
console.log('My friend has',friendsPets, 'pet(s)');
...
if(pets > friendsPets){
    ...
    console.log('I have the same number of pets as my friend')
}
